...
public class FizzBuzzTest {
    ...
    public void divisibleBy3() {
        ...
        assertEquals("Fizz", result);    // Insert your test code here
    }
    ...
    public void divisibleBy5() {
        ...
        assertEquals("Buzz", result);    // Insert your test code here
    }

    @Test void divisibleBy3And5() {
        FizzBuzz fizzBuzz = new FizzBuzz();
        String result = fizzBuzz.checkNumber(15);
        assertEquals("FizzBuzz", result);    // Insert your test code here
    }
